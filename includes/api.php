...
class API extends Integration {
	...
	/** @var string */
	public $integration_id = 'sendinblue';
	...
	/**
	 * Remove '+' part of emails for SendInBlue
	 * @param $email
	 * @return string
	 */
    ...
    /**
     * Remove everything but the number, and then add a +1 for North America
	...
	function get_contact_id_by_email( $email ) {
		...
		$response = $this->request( 'GET' , "/contacts/$email" );
